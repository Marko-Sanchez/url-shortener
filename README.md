...
the single threaded version uses getopt(3) which is a linux based function, Although this can be changed to work without being on a linux system using if-statements.  <br />
